...
inline bool Flags::isCarry(const u8 *flags) {
...
inline bool Flags::isHalfCarry(const u8 *flags) {
...
inline bool Flags::isSubstraction(const u8 *flags) {
...
inline bool Flags::isZero(const u8 *flags) {
